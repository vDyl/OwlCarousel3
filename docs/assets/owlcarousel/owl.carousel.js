/*! Owl Carousel v3.0.1 | MIT License */
...
(function() {
  ...
  (function($, window2, document2, undefined) {
    ...
    Owl.prototype.prepare = function(item) {
      ...
      if (!event.data) {
        event.data = $("<" + this.settings.itemElement + "></" + this.settings.itemElement + ">").addClass(this.options.itemClass).append(item);
      }
    ...
    Owl.prototype.trigger = function(name, data, namespace, state, enter) {
      ...
      }, handler = $.grep(["on", name, namespace], function(v) {
        return v;
      }).join("-").toLowerCase().replace(/-([a-z])/g, function(match, character) {
